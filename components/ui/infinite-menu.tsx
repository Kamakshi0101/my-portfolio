  ...
  private initTexture(): void {
    ...
    Promise.all(
      ...
      images.forEach((img, i) => {
        ...
        ctx.drawImage(img, cropX, cropY, cropW, cropH, x, y, cellSize, cellSize);
      });
...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [], scale = 1.0 }) => {
  ...
  return (
    <div className="relative w-full h-full">
      <div className="pointer-events-none absolute inset-0 bg-linear-to-r from-black/45 via-transparent to-black/45 z-[1]" />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-linear-to-t from-black/60 to-transparent z-[1]" />
      ...
      {activeItem && (
        <>
          ...
          text-white
          drop-shadow-[0_4px_14px_rgba(0,0,0,0.9)]
          ${
            isMoving
